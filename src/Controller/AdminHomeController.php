...
class AdminHomeController extends AbstractController
{
    ...
    public function menu(Request $request): Response
    {
        ...
        $adminMenu = [
            ...
            ['title' => 'Listing User', 'text' => 'Liste Utilisateurs', 'url' => $this->generateUrl('app_admin_users'), 'icon' => 'bi bi-people'],
            ['title' => 'Ajout User', 'text' => 'Ajouter un Utilisateur', 'url' => $this->generateUrl('app_admin_create_user'), 'icon' => 'bi bi-person-plus'],
            ['title' => 'Listing Facture', 'text' => 'Liste Factures', 'url' => $this->generateUrl('app_admin_factures'), 'icon' => 'bi bi-filetype-pdf'],
            ...
            ['title' => 'Listing Demandes', 'text' => 'Liste Demandes', 'url' => $this->generateUrl('app_admin_demandes'), 'icon' => 'bi bi-newspaper'],
